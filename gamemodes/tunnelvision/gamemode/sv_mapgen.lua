...
DOOR_CONNECTION_TABLE["door_1"] = {PLACE_BOMBSITEA, PLACE_MIDDLE}
DOOR_CONNECTION_TABLE["door_2"] = {PLACE_BOMBSITEB, PLACE_MIDDLE}
DOOR_CONNECTION_TABLE["door_3"] = {PLACE_HOUSE, PLACE_HOSTAGERESCUEZONE}
DOOR_CONNECTION_TABLE["door_4"] = {PLACE_BOMBSITEC, PLACE_MARKET}
DOOR_CONNECTION_TABLE["door_5"] = {PLACE_MARKET, PLACE_TSPAWN}
DOOR_CONNECTION_TABLE["door_6"] = {PLACE_MARKET, PLACE_BRIDGE }
DOOR_CONNECTION_TABLE["door_7"] = {PLACE_APARTMENT, PLACE_CTSPAWN }
DOOR_CONNECTION_TABLE["door_8"] = {PLACE_APARTMENT, PLACE_VIPRESCUEZONE}
DOOR_CONNECTION_TABLE["door_9"] = {PLACE_MIDDLE, PLACE_HOUSE}
DOOR_CONNECTION_TABLE["door_10"] = {PLACE_MIDDLE, PLACE_MARKET}
DOOR_CONNECTION_TABLE["door_11"] = {PLACE_MIDDLE, PLACE_MARKET}
DOOR_CONNECTION_TABLE["door_12"] = {PLACE_APARTMENT, PLACE_MARKET}
DOOR_CONNECTION_TABLE["door_13"] = {PLACE_APARTMENT, PLACE_HOUSE}
DOOR_CONNECTION_TABLE["door_14"] = {PLACE_APARTMENT, PLACE_HOUSE}
DOOR_CONNECTION_TABLE["door_15"] = {PLACE_HOUSE, PLACE_MARKET}
		...
		if CanGetFromPlaceAToPlaceB( start_location, key_location, data.locked_doors ) then
			...
			for k, door in ipairs( locked_doors ) do
				...
				if CanGetFromPlaceToDoor( key_location, door, data.locked_doors ) then
					...
					data.spawns[i] = {data.num_keys, door}
